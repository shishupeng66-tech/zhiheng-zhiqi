...
def load_config():
    # fix: IsADirectoryError when the configured config path is a directory.
...
def save_config():
    ...
    with _config_save_lock:
        ...
        config_to_save["volcengine_tts"] = dict(volcengine_tts)
...
volcengine_tts = _SynchronizedConfig(_cfg.get("volcengine_tts", {}))
...
project_name = _cfg.get("project_name", "知衡智企")
